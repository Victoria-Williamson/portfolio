    ...
    [
        {
            ...
            title: "Project Title About Something Something Something",
...
<stop offset="0.880208" stop-color="#D62C49"/>
  ...
  spacing={5}>
      ...
      <Grid item xs={0}>
  <div class="outside">
  <div class="inside"><div class="container">
<img src="https://drupal8-prod.visitcalifornia.com/sites/drupal8-prod.visitcalifornia.com/files/styles/fluid_1200/public/2020-06/VC_Experiences_ReopeningBeaches_RF_1156532604_1280x640.jpg?itok=tPCjquVe" alt="Avatar" class="image"/>
<div class="overlay">
...
<a href={data.link}>
     <div id="Github-Proj">
     <svg height="40" width="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
