...
function titleDiv(data) {
  if (data.type === "Web Development") return;
  {
  }
}
function Projects() {
  ...
  const languages = [{ x: "Java" }, { x: "Java" }, { x: "Java" }];
  ...
  return (
    <div class="mt-4">
      <div
        ...
        class="shadow-2xl text-center sticky text-darkOrange hover:text-lightOrange right-0 ml-2 rounded-full h-12 w-12 z-40 top-20 bg-white ..."
      >
        <svg
          class="absolute  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fill-current my-auto mx-auto "
                          ...
                          <div class="text-center">
                            ...
                            <div class="flex flex-wrap justify-center">
                              {web.map((data) => (
                                ...
                                >
                                  <span class="inline-block hover:text-violet bg-darkPink rounded-full px-3 py-1 text-sm font-bold text-white font-black mr-2 mb-2">
                                    {data.title}{" "}
                                  </span>
                                </button>
                              ))}
                            ...
                            <div class="flex flex-wrap justify-center">
                              {ml.map((data) => (
                                ...
                                >
                                  <span class="inline-block hover:text-violet bg-darkOrange text-white font-black rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                                    {data.title}{" "}
                                  </span>
                                </button>
                              ))}
                            ...
                            <div class="flex flex-wrap justify-center">
                              {other.map((data) => (
                                ...
                                >
                                  <span class="inline-block bg-darkGreen  rounded-full px-3 py-1 text-sm font-black text-white mr-2 mb-2">
                                    {data.title}{" "}
                                  </span>
                                </button>
                              ))}
      ...
      <div id="projectInfo">
                              ...
                              {(() => {
                                if (info.github) {
                                  return (
                                    <a
                                      id="link"
                                      class="inline-block text-darkPink no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-0 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out"
                                      href={info.github}
                                    >
                                      <svg
                                        class="fill-current h-18 "
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                                  ...
                                  return (
                                    <div
                                      id="link"
                                      class="inline-block text-gray-300  text-center h-10 p-0 md:h-auto md:p-4 transform"
                                    >
                                      <svg
                                  ...
                                  return (
                                    ...
                                    >
                                      <svg
                                        ...
                                        viewBox="0 0 24 24"
                                      >
                                        <path d="M0 0v24h24v-24h-24zm22 22h-20v-16h20v16zm-1-15h-18v14h18v-14zm-10 5.649l-3.229 1.351 3.229 1.347v1.653l-5-2.201v-1.599l5-2.2v1.649zm7 2.15l-5 2.201v-1.653l3.229-1.347-3.229-1.351v-1.649l5 2.201v1.598z" />
                                      </svg>
                                    </a>
                                  );
                                } else {
       ...
       <Chip size="small" label={lan}/>
                        ...
                        <text class=" text-lg font-bold text-center font-extrabold">
                          {" "}
                          TechStack{" "}
                        </text>
                        ...
                        <div class="flex flex-wrap justify-center mt-3">
                          {info.languages.map((lan) => (
                            <div class="flex justify-center items-center m-1 font-medium py-1 px-2 bg-white rounded-full text-gray-700 bg-gray-100 border border-gray-300 ">
                              <div class="text-md font-bold leading-none max-w-full flex-initial">
                                {" "}
                                {lan}{" "}
                              </div>
                            </div>
                        ...
                        <img className="my-3" src={info.img} />

                        <text class="text-lg mt-3 text-center font-extrabold">
                          {" "}
                          Summary{" "}
                        </text>
                        <br />
      ...
      <div class="h-auto  grid grid-rows-2 items-center justify-center grid-flow-col gap-4 text-center">
        <div class="text-gradient font-extrabold text-white text-4xl font-bold">
          {" "}
          Projects <div></div>{" "}
      ...
      <div class="h-auto  grid grid-rows-2 items-center justify-center grid-flow-col gap-4 text-center">
        <div class="text-gradient font-extrabold text-white text-3xl ">
          {" "}
      ...
      <div class="mt-8 bg-gradient-to-r from-darkPink via-darkOrange to-darkGreen">
        ...
        >
          {projectInformation.map((data) => (
            <Grid item xs={0}>
              <div class="p-10">
                <div class="max-w-sm w-72 rounded overflow-hidden shadow-lg no-underline  text-black hover:text-black transition duration-500 ease-in-out 0 transform hover:-translate-y-1 hover:no-underline hover:scale-110 ">
                  <a
                    href={data.link}
                    target={"_blank"}
                    className="no-underline hover:no-underline text-black hover:text-black "
                  >
                    <img
                      class="w-72 bg-darkBlack h-60  object-cover"
                      class="lazy"
                      src={data.img}
                      alt="Project Image"
                    />
      ...
      <div class="h-auto  grid grid-rows-2 items-center justify-center grid-flow-col gap-10 text-center">
        <div class="mt-8 -mb-8 text-gradient font-extrabold text-white text-3xl font-bold">
          {" "}
      ...
      <div class="flex flex-wrap flex-row gap-3 items-center justify-center">
        {allProjects.map((data) => {
              ...
              <div id={data.title.replace(/\s/g, "")}>
                ...
                >
                  <div class="w-80 m-5 h-72 bg-gradient-to-r from-darkPink via-darkPink to-lightPink rounded-lg font-bold text-4xl text-white flex  justify-center flex-col items-center text-center p-3 transition duration-500 ease-in-out 0 transform hover:-translate-y-1 hover:no-underline hover:scale-110 ">
                    ...
                    <text class="text-center block hover:hidden">
                      {" "}
                      {data.title}{" "}
                    </text>
                    <text class="text-2xl font-medium block hover:hidden">
                      {" "}
                      {data.type}{" "}
                    </text>
                  </div>
          ...
          <div id={data.title.replace(/\s/g, "")}>
            <a
              id="link"
              class="inline-block font-bold text-pink-500 no-underline hover:text-pink-300 hover:text-underline text-center h-10 p-0 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out m- hover:no-underline"
              onClick={() => getProjectInfo(data)}
            >
