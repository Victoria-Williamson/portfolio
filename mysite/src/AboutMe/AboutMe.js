...
<div id="about-border">
<div class="flex items-center justify-between absolute z-10 ">
                    <div class="flex flex-col  items-center w-96 items-start lg:items-center rounded bg-white shadow">
                        <div class="w-96 h-60 dark:bg-gray-800 flex flex-col items-center">
                        <img class="object-fit h-60 p-4" src={Self}>
                          </img></div>
                        <div class="w-96  h-72 dark:border-gray-700 border-t lg:border-t-0 lg:border-r lg:border-l lg:rounded-r dark:bg-gray-700 bg-gray-100 text-center p-2 mx-5 font-medium">
                         <text>
