  ...
  return (
    <div class="mt-5 h-auto">
      ...
      <div class="grid grid-rows-2 items-center justify-center sm:grid-flow-row grid-flow-col gap-2 text-center">
        <div class="text-gradient font-bold text-white text-3xl">
          {" "}
          Languages <div></div>{" "}
        </div>
      </div>
        ...
        {data.languages.map((lang) => {
          return (
            <div class="lg:w-32 lg:h-32 h-20 w-20 m-2 inline-flex items-center justify-center rounded-full bg-white mb-5 flex-shrink-0 text-center align-middle">
              <img
                class="w-5/6 h-5/6 flex items-center justify-center object-scale-down px-1"
                alt={lang.title}
                src={lang.image}
              />
            </div>
      ...
      <div class="h-auto mt-5  lg:px-64 flex-wrap flex grid grid-rows-2 items-center justify-center sm:grid-flow-row grid-flow-col gap-2 text-center">
        <div class="text-gradient font-extrabold text-white text-3xl font-bold">
          {" "}
          Frameworks <div></div>{" "}
        </div>
      </div>
      ...
      <div class="flex flex-col xl:grid xl:grid-cols-3 gap-2 justify-center mt-4 xl:gap-0 xl:mx-20">
        <div class="mx-8 px-5">
          <h2 class="title-font tracking-widest text-lightPink text-lg font-bold text-center sm:text-left mt-3">
              ...
              return (
                <ul>
                  <span class=" text-2xl w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                    <svg
                      class="fill-current text-darkPink"
        ...
        <div class="mx-8 px-5">
          <h2 class="title-font tracking-widest text-lightOrange text-lg font-bold text-center sm:text-left mt-3">
            ...
            {data.compSci.map((course) => {
              return (
                <ul>
                  <span class=" text-2xl w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                    <svg
                      class="fill-current text-darkOrange"
                      xmlns="http://www.w3.org/2000/svg"
                      width="100%"
                      height="100%"
                      viewBox="0 0 24 24"
        ...
        <div class="mx-8 px-5">
          <h2 class="title-font tracking-widest text-lg font-bold text-center sm:text-left text-darkGreen mt-3 ">
            Electives
          </h2>
          <li class="text-white list-none text-lg ">
            {data.electives.map((course) => {
              return (
                <ul>
                  <span class=" text-2xl w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                    <svg
                      class="fill-current text-darkGreen"
                      xmlns="http://www.w3.org/2000/svg"
                      width="100%"
                      height="100%"
                      viewBox="0 0 24 24"
