            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <a
                    href="#home"
                    className="text-gray-50 text-2xl no-underline hover:text-pink-500 hover:no-underline text-center h-10 p-0 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out px-3 py-2 rounded-md text-base md:text-l font-bold font-bold"
                  >
                    Home
                  </a>
                  <a
                  ...
                  <a
                    href="#projects"
                    className="text-gray-50 no-underline text-2xl hover:text-pink-500 hover:no-underline text-center h-10 p-0 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out px-3 py-2 rounded-md text-base md:text-l font-bold font-bold"
                  >
                    Projects
                  </a>
