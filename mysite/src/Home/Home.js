  ...
  spacing={3}>
      ...
      <div class="Location">Orlando,FL</div>
          ...
          spacing={5}>
              ...
              <button
                class="rounded-full bg-gradient-to-r from-purple-600 via-pink-500 to-red-50 hover:from-green-400 to-blue-500 text-white font-bold py-2 px-4 rounded focus:ring transform transition hover:scale-105 duration-300 ease-in-out"
                type="button"
              >
                Resume
                <GetAppIcon/>
          ...
          spacing={2}>
                  <Grid id="grid2" item xs = {20}>
                        <div className=" rounded-full h-24 w-24 flex items-center justify-center bg-gradient-to-r from-blue-500 via-blue-500 to-blue-500 hover:from-green-400 to-blue-500 text-white font-bold py-2 px-4 focus:ring transform transition hover:scale-105 duration-300 ease-in-out">
