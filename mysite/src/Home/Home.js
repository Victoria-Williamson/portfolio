  ...
  return <div class="background">
    <div class="flex h-screen  w-screen text-center flex-col items-center justify-center">
      <div class="flex h-screen flex-col w-screen gap-4 items-center justify-center lg:px-16">
        <img className="w-full xl:w-5/6 xl:max-w-7xl object-contain lg:px-32 md:px-12 px-10" src={Title} />
        <div class="flex flex-row  w-screen px-2 text-center gap-5 items-center justify-center">
          ...
          <div class="mx-2 ">
            <a href="https://www.linkedin.com/in/victoria-williamson-8394331a1/">
              <img className="transform hover:-translate-y-1 object-fit h-12 lg:h-20 w- hover:scale-110 transition duration-500 ease-in-out" src={LinkedIn} />
            </a>
          </div>
          ...
          <div class="mx-2">
            <a href="https://www.canva.com/design/DAEpp7QDs9s/YXxPaa7IRmjzm8URN-yTdg/view?utm_content=DAEpp7QDs9s&utm_campaign=designshare&utm_medium=link&utm_source=sharebutton">
              <img className="transform hover:-translate-y-1 object-fit h-16 lg:h-20 w-full hover:scale-110 transition duration-500 ease-in-out" src={Resume} />
            </a>
          </div>
        </div>
      </div>
