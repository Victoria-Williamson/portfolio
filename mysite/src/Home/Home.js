        ...
        <div class="flex flex-row  w-screen px-2 text-center gap-5 items-center justify-center mb-8">
          <div class="mx-2 ">
            <a href="https://github.com/Victoria-Williamson">
              <img className="transform hover:-translate-y-1 object-fit h-12 lg:h-14 w-full hover:scale-110 transition duration-500 ease-in-out" src={GitHub} />
            </a>
          </div>
          <div class="mx-2">
            <a href="https://twitter.com/ViWilliamson/" class="">
              <img className="transform hover:-translate-y-1 object-fit h-12 lg:h-14 w-full hover:scale-110 transition duration-500 ease-in-out" src={Twitter} />
            </a>
          </div>
          <div class="mx-2 ">
            <a href="https://www.linkedin.com/in/victoria-williamson-8394331a1/">
              <img className="transform hover:-translate-y-1 object-fit h-12 lg:h-14 w-full hover:scale-110 transition duration-500 ease-in-out" src={LinkedIn} />
            </a>
          </div>
          ...
          <div class="mx-2">
            <a href="https://www.canva.com/design/DAEpp7QDs9s/YXxPaa7IRmjzm8URN-yTdg/view?utm_content=DAEpp7QDs9s&utm_campaign=designshare&utm_medium=link&utm_source=sharebutton">
              <img className="transform hover:-translate-y-1 object-fit h-16 lg:h-14 w-full hover:scale-110 transition duration-500 ease-in-out" src={Resume} />
            </a>
          </div>
        </div>
      </div>
